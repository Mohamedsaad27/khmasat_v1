...
const PropertyCard = ({
    ...
    return (
        <div className="item overflow-hidden relative h-[400px] w-full lg:w-[32%] md:w-[49%] mb-4 border border-gray-300 rounded-lg">
            {/* Link item */}
            <a href={propertyRoute} className="link absolute w-full h-full z-[25]"></a>
            ...
            <div className="relative p-3 h-[40%]">
                ...
                {tag && (
                    <div className="absolute top-[10px] left-[10px] flex item-center justify-center border border-green-500 rounded-md">
                        <p className="text-[12px] px-3 py-1 text-green-500 font-bold">جديد</p>
                    </div>
                )}
                {/* Price */}
                ...
                <div className="flex items-center mt-2">
                    {/* Property Type */}
                    <p className="pl-2 text-[16px] font-[500] border-l border-gray-300">{propertyType}</p>
                    ...
                    <p className="font-[500] pl-2 text-[16px] border-l border-gray-300">{bedroom}</p>
                    ...
                    <p className="font-[500] pl-2 text-[16px] border-l border-gray-300">{bathroom}</p>
                    ...
                    <p className="font-[500] text-[16px]">{area} <span>م<sup>2</sup></span></p>
                </div>
                ...
                <div className="group py-1 hover:py-2 absolute bottom-[10px] left-[15px] w-[40px] z-[201] flex flex-col justify-center items-center bg-sky-200 rounded-md transition-all duration-300 ease-in-out translate-y-[83%] hover:translate-y-0 hover:bg-blue-100 cursor-pointer">
                    ...
                    <div className="py-1 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition duration-300 delay-300 transform -translate-x-full">
                        <a href="#" className="text-white text-gray-800 hover:bg-green-500 transition duration-200 flex items-center justify-center w-[28px] h-[28px] rounded-md bg-green-400">
                    ...
                    <div className="py-1 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition duration-300 delay-500 transform -translate-x-full">
                        <a href="#" className="text-white text-gray-800 hover:bg-red-500 transition duration-200 flex items-center justify-center w-[28px] h-[28px] rounded-md bg-red-400 text-[16px]">
                    ...
                    <div className="py-1 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition duration-300 delay-700 transform -translate-x-full">
                        <a href="#" className="text-white text-gray-800 hover:bg-blue-500 transition duration-200 flex items-center justify-center w-[28px] h-[28px] rounded-md bg-blue-400 text-[16px]">
