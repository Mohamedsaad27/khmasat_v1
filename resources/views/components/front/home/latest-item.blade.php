    ...
    <div class="pt-3 h-[40%]">
        ...
        <div class="flex items-center justify-between mt-1">
            <div class="flex items-center">
                <svg width="20" height="24" viewBox="0 0 24 24" class="text-sky-500" fill="none"
            ...
            <div>
                <p class="font-bold text-sky-500">{{ $type }}</p>
            </div>
        </div>
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                {{-- badroom --}}
                <svg width="22" height="24" viewBox="0 0 24 24" class="text-sky-500" fill="none"
                ...
                <p class="text-[16px] font-[500] ml-2">{{ $bedroom }}</p>
                ...
                <p class="text-[16px] font-[500] ml-2">{{ $bathroom }}</p>
