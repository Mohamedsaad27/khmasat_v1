<x-admin-layout>
    ...
    <div class="p-5">
        ...
        <div class="mb-10">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                aria-current="page">المميزات</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            {{-- title page --}}
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white mt-4">المميزات</h1>
        </div>
        {{-- END Breadcrumb --}}
                    ...
                    <div class="overflow-hidden shadow">
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @if($benefits->isEmpty())
                                    <tr>
                                        <td colspan="2" class="p-4 text-center text-gray-500 dark:text-gray-400">لا يوجد ميزات</td>
                                    </tr>
                                @else
                                    ...
                                    <td class="p-4 whitespace-nowrap flex justify-between">
                                        <div>
                                            <a href="{{ route('benefits.edit', ['benefit' => $benefit->id]) }}"
                                            ...
                                            <form action="{{ route('benefits.destroy', ['benefit' => $benefit->id]) }}" method="POST" class="inline-block" onsubmit="return confirm('هل أنت متأكد أنك تريد حذف هذه الفائدة؟');">
                                                @csrf
                                                @method('DELETE')
        ...
        <script>
            function deleteBenefit(id) {
                if (confirm('Are you sure you want to delete this benefit?')) {
                    window.location.href = '/admin/benefits/' + id + '/destroy';
                }
            }
        </script>
    @endpush
