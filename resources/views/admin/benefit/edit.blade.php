<x-admin-layout>
    ...
    <div class="p-5">
        ...
        <div class="mb-10">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('benefits.index') }}"
                                class="mr-1 text-gray-700 hover:text-primary-600 md:mr-2 dark:text-gray-300 dark:hover:text-white">المميزات</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">تعديل ميزة</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            {{-- title page --}}
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white mt-4">تعديل ميزة</h1>
        </div>
        {{-- END Breadcrumb --}}

        <form class="flex flex-wrap justify-between" action="{{ route('benefits.update', ['benefit' => $benefit->id]) }}" method="POST"
            ...
            <div
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" value="{{ $benefit->name }}"
                        ...
                        placeholder="ادخل عنوان للميزة" required value="{{ old('name') }}">
                    @error('name')
