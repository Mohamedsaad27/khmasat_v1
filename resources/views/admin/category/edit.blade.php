<x-admin-layout>
    ...
    <div class="p-5">
        ...
        <div class="mb-10">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('categories.index') }}"
                                class="mr-1 text-gray-700 hover:text-primary-600 md:mr-2 dark:text-gray-300 dark:hover:text-white">الانواع</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">تعديل نوع عقار</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            {{-- title page --}}
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white mt-4">تعديل نوع عقار</h1>
        </div>
        {{-- END Breadcrumb --}}

        <form class="flex flex-wrap justify-between" action="{{ route('categories.update', ['category' => $category->id]) }}" method="POST"
