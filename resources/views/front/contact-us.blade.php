                    ...
                    <div>
                        ...
                        <div class="flex items-center mt-5">
                            <a href="https://www.facebook.com/profile.php?id=100091588466241&mibextid=ZbWKwL"
                                ...
                                <svg class="relative z-10 fill-white transition-all duration-300 group-hover:fill-white"
                            ...
                            <a href="https://www.tiktok.com/@ahmedzeiozeiozeio?_t=8qJqwZANVAL&_r=1"
                                class="w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-gray-800 group transition-all duration-300 ml-2">
                                <svg class="fill-white relative z-10 transition-all duration-300 group-hover:fill-white"
                                    xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 42 47"
                                    fill="none">
                            ...
                            <a href="https://wa.me/+218944711252"
                                class="w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full bg-green-400 group transition-all duration-300 ml-2">
                                <svg class="fill-white relative z-10 transition-all duration-300 group-hover:fill-white"
                                ...
                                <div
                                    class="absolute top-full left-0 w-full h-full rounded-full bg-green-500 z-0 transition-all duration-500 group-hover:top-0">
                                </div>
                            </a>
