            ...
            <div class="flex flex-wrap justify-between">
                ...
                <div
                        ...
                        <div id="controls-carousel" class="controls-carousel relative w-full h-full group"
                            ...
                            <div class="carousel-wrapper relative h-full overflow-hidden rounded-tl-lg rounded-tr-lg">
                                ...
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img loading="lazy" src="{{ $property->propertyImages->first()->image_path }}"
                    ...
                    <div class="relative p-3 h-[40%]">
                        ...
                        {{-- price --}}
                        <p class="font-bold text-[20px]">{{ $property->price }} ج.م</p>

                        <div class="flex items-center mt-2">
                            {{-- type --}}
                            <p class="pl-2 text-[16px] font-[500] border-l border-gray-300">{{ $property->category->name }}</p>
                            ...
                            <p class="font-[500] pl-2 text-[16px] border-l border-gray-300">{{ $property->bedrooms }}</p>
                            ...
                            <p class="font-[500] pl-2 text-[16px] border-l border-gray-300">{{ $property->bathrooms }}</p>
                            ...
                            <p class="font-[500] text-[16px]">{{$property->area}}<span>م<sup>2</sup></span></p>
                        </div>

                        <div class="flex items-center mt-2">
                            <i class="fa-solid fa-location-dot text-[16px]"></i>
                            <p class="mr-1 text-[16px] font-[500]">
                                <span>{{ $property->address->country ?? 'ليبيا' }}</span>
                                |
                                <span>{{ $property->address->city ?? 'غير محدد' }}</span>
                                |
                                <span>{{ $property->address->street ?? 'غير محدد' }}</span>
                            </p>
                        </div>
                        ...
                        <div class="flex items-center bg-blue-100 text-blue-500 p-2 rounded w-fit mt-2 text-[10px]">
                            ...
                            <p><span class="font-[500]">مقدم :</span><span>{{ $property->installment_amount }} ج.م</span></p>
                            @else
