...
<body>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
                        ...
                        <svg id="toggleSidebarMobileHamburger" class="w-6 h-6 transform rtl:rotate-180"
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
        ...
        {{-- Start Sidebar  --}}
        <aside id="sidebar"
            class="fixed top-0 right-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width"
            aria-label="Sidebar">
            <div
                class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto custom-scrollbar">
                    <div
                            ...
                            <li>
                                ...
                                <ul id="dropdown-crud" class="space-y-2 py-2"> {{-- {{ if not (eq .Params.group "crud") }}hidden {{ end }} --}}
                                    <li>
                                        ...
                                        {{-- {{ if eq $page_slug "products" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
                                    </li>
                                    <li>
                                        <a href=""
                                        ...
                                        {{-- {{ if eq $page_slug "users" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href=""
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
                                    {{-- {{ if eq $page_slug "settings" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
                                    <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                        aria-hidden="true">
                                        <path clip-rule="evenodd" fill-rule="evenodd"
                            ...
                            <li>
                                ...
                                <ul id="dropdown-playground" class="space-y-2 py-2 "> {{-- {{ if not (eq .Params.group "playground") }}hidden {{ end }} --}}
                                    <li>
                                        ...
                                        {{-- {{ if eq $page_slug "stacked" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
                                    </li>
                                    <li>
                                        <a href=""
                                        ...
                                        {{-- {{ if eq $page_slug "sidebar" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
                                    </li>
                                </ul>
                            </li>
                        </ul>
        ...
        <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:mr-64 dark:bg-gray-900">
                            ...
                            <div class="items-center sm:flex">
                                <div class="flex items-center">
                                    <button id="dropdownDefault" data-dropdown-toggle="dropdown"
                                        class="mb-4 sm:mb-0 ml-4 inline-flex items-center text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-4 py-2.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
                                        type="button">
                                        Filter by status
            ...
            <p class="my-10 text-sm text-center text-gray-500">
                &copy; 2019- <a href="" class="hover:underline" target="_blank">Flowbite.com</a>. All
                rights reserved.
            </p>
            {{-- End Footer --}}
