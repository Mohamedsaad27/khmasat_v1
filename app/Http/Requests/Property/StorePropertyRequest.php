...
class StorePropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'price_after_discount' => 'nullable|numeric|min:0|lt:price',
            'feature' => 'boolean',
    ...
    public function messages(): array
    {
        return [
            ...
            'price_after_discount.numeric' => 'مبلغ الخصم يجب أن يكون رقمًا.',
            'price_after_discount.min' => 'مبلغ الخصم يجب أن يكون 0 أو أكثر.',
            'price_after_discount.lt' => 'المبلغ بعد الخصم يجب أن يكون أقل من السعر.',
